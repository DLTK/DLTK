...
def upscore_layer_3D(inputs, inputs2, out_filters, in_filters=None, strides=(2, 2, 2),
    ...
    Args:
        ...
        out_filters (int): Number of output filters (typically, number of segmentation classes)
