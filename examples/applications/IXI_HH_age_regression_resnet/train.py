...
def model_fn(features, labels, mode, params):
    ...
    net_output_ops = resnet_3d(features['x'], num_res_units=2,
                               num_classes=NUM_CLASSES,
                               filters=(16, 32, 64, 128, 256),
                               strides=((1, 1, 1), (2, 2, 2), (2, 2, 2),
                                        (2, 2, 2), (2, 2, 2)),
                               mode=mode, kernel_regularizer=
    ...
    loss = tf.losses.mean_squared_error(labels=labels['y'],
...
def train(args):
    ...
    all_filenames = pd.read_csv(args.data_csv, dtype=object,
    ...
    reader_params = {'n_examples': 2, 'example_size': [64, 96, 96],
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Example: IXI HH resnet '
