...
def model_fn(features, labels, mode, params):
    ...
    net_output_ops = residual_unet_3d(
        features['x'], NUM_CLASSES, num_res_units=2, filters=(16, 32, 64, 128),
    ...
    my_image_summaries['predictions'] = \
        tf.cast(net_output_ops['y_'], tf.float32)[0, 0, :, :]
    ...
    dice_tensor = tf.py_func(dice, [net_output_ops['y_'], labels['y'],
...
def train(args):
    ...
    all_filenames = pd.read_csv(args.train_csv, dtype=object,
    ...
    reader_params = {'n_examples': 18, 'example_size': [4, 128, 128],
