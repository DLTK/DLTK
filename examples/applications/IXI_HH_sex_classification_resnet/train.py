...
def model_fn(features, labels, mode, params):
    ...
    net_output_ops = resnet_3d(
        features['x'], num_res_units=2, num_classes=NUM_CLASSES,
    ...
    one_hot_labels = tf.reshape(
        tf.one_hot(labels['y'], depth=NUM_CLASSES), [-1, NUM_CLASSES])
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Example: IXI HH resnet sex'
